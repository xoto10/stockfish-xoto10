...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score Outpost[][3] = {
    { S(22, 6), S(36,12), S(44,16) }, // Knight
    { S( 9, 2), S(15, 5), S( 9, 2) }  // Bishop
  };
        ...
        if (Pt == BISHOP || Pt == KNIGHT)
        {
            ...
            if (bb & s)
                score += Outpost[Pt == BISHOP]
                                ...
                                + bool(double_pawn_attacks_bb<Us>(pos.pieces(Us, PAWN)))] * 2;

            else if (bb &= b & ~pos.pieces(Us))
                score += Outpost[Pt == BISHOP]
                                [ bool(attackedBy[Us][PAWN] & bb)
                                + bool(double_pawn_attacks_bb<Us>(pos.pieces(Us, PAWN)))];

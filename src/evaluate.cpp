...
namespace {
  ...
  Score Evaluation<T>::evaluate_pieces() {
    ...
    while ((s = *pl++) != SQ_NONE)
    {
        ...
        b = Pt == BISHOP ? attacks_bb<BISHOP>(s, pos.pieces() ^ pos.pieces(BISHOP, QUEEN) ^ pos.pieces(KING))
          : Pt ==   ROOK ? attacks_bb<  ROOK>(s, pos.pieces() ^ pos.pieces(ROOK, QUEEN) ^ pos.pieces(KING))

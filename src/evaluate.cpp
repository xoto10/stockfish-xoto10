...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score TrappedRook         = S( 40,  4);
...
{
                    score -= TrappedRook * (1 + !pos.castling_rights(Us) + pos.can_castle_at_root(Us));
//sync_cout << "info string pos\n" << pos << " tr: us " << Us << " sq " << UCI::square(s) << pos.can_castle_at_root(Us)
//          << sync_endl;
}
            }
        }

...
Value Eval::evaluate(const Position& pos) {
  ...
  else
  {
      ...
      Value prevSc = Threads.main()->bestPreviousScore == VALUE_INFINITE ? VALUE_ZERO
                                                                         : Threads.main()->bestPreviousScore;
      bool  largeSc = prevSc * 16 > (NNUEThreshold1 + pos.non_pawn_material() / 64) * r50;
      bool  classical = largeSc || (prevSc > PawnValueMg / 4 && !(pos.this_thread()->nodes & 0xB));

...
#undef S
  ...
  Score Evaluation<T>::initiative(Score score) const {
    ...
    bool npmOnBothFlanks =   ((pos.pieces(ALL_PIECES) ^ pos.pieces(KING, PAWN)) & QueenSide)
                          && ((pos.pieces(ALL_PIECES) ^ pos.pieces(KING, PAWN)) & KingSide);
    ...
    // Compute the midgame initiative bonus for the attacking side

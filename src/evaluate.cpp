...
int bucketWeight[8] = {119, 137, 125, 127, 127, 140, 139, 156};  // values after 17% of the LTC tune, remove tempo from nuue. Bench: 3605577
...
Value Eval::evaluate(const Position& pos) {
  ...
  else
  {
      ...
      auto  adjusted_NNUE = [&]()
      {
         ...
         nnue = (nnue - 28) * scale / 1024 + Time.tempoNNUE;

...
#undef S
  ...
  void Evaluation<T>::initialize() {
    ...
    kingAttackersCount[Them] = 224 * popcount(kingRing[Us] & pe->pawn_attacks(Them));
  ...
  Score Evaluation<T>::king() const {
    ...
    kingDanger +=        kingAttackersCount[Them] * kingAttackersWeight[Them] / 256

...
namespace {
  ...
  constexpr Score Semiopen[256] = {
    S(-7,-3), S(-7,-3), S( 3, 2), S(-7,-3), S(-7,-3), S( 3, 2), S( 3, 2), S(-7,-3),
    S(-7,-3), S(-7,-3), S( 3, 2), S( 3, 2), S(-7,-3), S( 3, 2), S( 3, 2), S(-7,-3),
    S(-7,-3), S(-7,-3), S( 3, 2), S(-7,-3), S( 3, 2), S( 3, 2), S( 3, 2), S( 3, 2),
    S(-7,-3), S(-7,-3), S( 3, 2), S( 3, 2), S(-7,-3), S( 3, 2), S( 3, 2), S(-7,-3),
    S(-7,-3), S(-7,-3), S( 3, 2), S(-7,-3), S(-7,-3), S( 3, 2), S( 3, 2), S(-7,-3),
    S( 3, 2), S( 3, 2), S( 8, 6), S( 3, 2), S( 3, 2), S( 3, 2), S( 3, 2), S(-7,-3),
    S(-7,-3), S(-7,-3), S( 3, 2), S(-7,-3), S( 3, 2), S( 3, 2), S( 3, 2), S(-7,-3),
    S(-7,-3), S(-7,-3), S( 3, 2), S(-7,-3), S(-7,-3), S( 3, 2), S(-7,-3), S(-7,-3),
    S( 3, 2), S( 3, 2), S( 3, 2), S( 3, 2), S( 3, 2), S( 3, 2), S( 3, 2), S( 3, 2),
    S( 3, 2), S( 3, 2), S( 8, 6), S( 3, 2), S( 3, 2), S( 3, 2), S( 3, 2), S(-7,-3),
    S( 3, 2), S( 3, 2), S( 8, 6), S( 3, 2), S( 8, 6), S(13, 9), S(13, 9), S( 8, 6),
    S( 3, 2), S( 3, 2), S(13, 9), S( 8, 6), S( 3, 2), S( 8, 6), S( 8, 6), S( 3, 2),
    S( 3, 2), S(-7,-3), S( 3, 2), S(-7,-3), S( 3, 2), S( 3, 2), S( 3, 2), S(-7,-3),
    S( 3, 2), S( 3, 2), S(13, 9), S( 8, 6), S( 3, 2), S( 8, 6), S( 8, 6), S( 3, 2),
    S( 3, 2), S( 3, 2), S( 3, 2), S(-7,-3), S( 3, 2), S( 8, 6), S( 8, 6), S( 3, 2),
    S( 3, 2), S(-7,-3), S( 8, 6), S( 3, 2), S(-7,-3), S( 3, 2), S( 3, 2), S(-7,-3),
    S(-7,-3), S(-7,-3), S( 3, 2), S(-7,-3), S(-7,-3), S( 3, 2), S( 3, 2), S(-7,-3),
    S(-7,-3), S(-7,-3), S( 3, 2), S( 3, 2), S(-7,-3), S( 3, 2), S( 3, 2), S(-7,-3),
    S(-7,-3), S(-7,-3), S( 3, 2), S(-7,-3), S( 3, 2), S( 3, 2), S( 3, 2), S(-7,-3),
    S(-7,-3), S(-7,-3), S( 3, 2), S(-7,-3), S(-7,-3), S(-7,-3), S(-7,-3), S(-7,-3),
    S( 3, 2), S( 3, 2), S( 3, 2), S( 3, 2), S( 3, 2), S( 3, 2), S( 3, 2), S(-7,-3),
    S( 3, 2), S( 3, 2), S(13, 9), S( 8, 6), S( 3, 2), S( 8, 6), S( 8, 6), S( 3, 2),
    S( 3, 2), S( 3, 2), S( 3, 2), S(-7,-3), S( 3, 2), S( 8, 6), S( 8, 6), S( 3, 2),
    S( 3, 2), S(-7,-3), S( 8, 6), S( 3, 2), S(-7,-3), S( 3, 2), S( 3, 2), S(-7,-3),
    S(-7,-3), S(-7,-3), S( 3, 2), S(-7,-3), S(-7,-3), S( 3, 2), S( 3, 2), S(-7,-3),
    S(-7,-3), S(-7,-3), S( 3, 2), S( 3, 2), S(-7,-3), S( 3, 2), S(-7,-3), S(-7,-3),
    S( 3, 2), S( 3, 2), S( 3, 2), S(-7,-3), S( 3, 2), S( 8, 6), S( 8, 6), S( 3, 2),
    S( 3, 2), S(-7,-3), S( 8, 6), S( 3, 2), S( 3, 2), S( 3, 2), S( 3, 2), S( 3, 0),
    S(-7,-3), S(-7,-3), S( 3, 2), S(-7,-3), S(-7,-3), S(-7,-3), S(-7,-3), S(-7,-3),
    S( 3, 2), S(-7,-3), S( 8, 6), S( 3, 2), S(-7,-3), S( 3, 2), S( 3, 2), S( 3, 0),
    S(-7,-3), S(-7,-3), S(-7,-3), S(-7,-3), S(-7,-3), S( 3, 2), S( 3, 2), S( 3, 0),
    S(-7,-3), S(-7,-3), S( 3, 2), S( 3, 0), S(-7,-3), S(-7,-3), S(-7,-3), S(-7,-3) };

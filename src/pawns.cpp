...
namespace {
  ...
  constexpr Score Semiopen[256] = {
    S( 0, 0), S( 0, 0), S( 9, 5), S( 0, 0), S( 0, 0), S( 9, 5), S( 9, 5), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 9, 5), S( 9, 5), S( 0, 0), S( 9, 5), S( 9, 5), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 9, 5), S( 0, 0), S( 9, 5), S( 9, 5), S( 9, 5), S( 9, 5),
    S( 0, 0), S( 0, 0), S( 9, 5), S( 9, 5), S( 0, 0), S( 9, 5), S( 9, 5), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 9, 5), S( 0, 0), S( 0, 0), S( 9, 5), S( 9, 5), S( 0, 0),
    S( 9, 5), S( 9, 5), S(14, 9), S( 9, 5), S( 9, 5), S( 9, 5), S( 9, 5), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 9, 5), S( 0, 0), S( 9, 5), S( 9, 5), S( 9, 5), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 9, 5), S( 0, 0), S( 0, 0), S( 9, 5), S( 0, 0), S( 0, 0),
    S( 9, 5), S( 9, 5), S( 9, 5), S( 9, 5), S( 9, 5), S( 9, 5), S( 9, 5), S( 9, 5),
    S( 9, 5), S( 9, 5), S(14, 9), S( 9, 5), S( 9, 5), S( 9, 5), S( 9, 5), S( 0, 0),
    S( 9, 5), S( 9, 5), S(14, 9), S( 9, 5), S(14, 9), S(19,12), S(19,12), S(14, 9),
    S( 9, 5), S( 9, 5), S(19,12), S(14, 9), S( 9, 5), S(14, 9), S(14, 9), S( 9, 5),
    S( 9, 5), S( 0, 0), S( 9, 5), S( 0, 0), S( 9, 5), S( 9, 5), S( 9, 5), S( 0, 0),
    S( 9, 5), S( 9, 5), S(19,12), S(14, 9), S( 9, 5), S(14, 9), S(14, 9), S( 9, 5),
    S( 9, 5), S( 9, 5), S( 9, 5), S( 0, 0), S( 9, 5), S(14, 9), S(14, 9), S( 9, 5),
    S( 9, 5), S( 0, 0), S(14, 9), S( 9, 5), S( 0, 0), S( 9, 5), S( 9, 5), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 9, 5), S( 0, 0), S( 0, 0), S( 9, 5), S( 9, 5), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 9, 5), S( 9, 5), S( 0, 0), S( 9, 5), S( 9, 5), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 9, 5), S( 0, 0), S( 9, 5), S( 9, 5), S( 9, 5), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 9, 5), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0),
    S( 9, 5), S( 9, 5), S( 9, 5), S( 9, 5), S( 9, 5), S( 9, 5), S( 9, 5), S( 0, 0),
    S( 9, 5), S( 9, 5), S(19,12), S(14, 9), S( 9, 5), S(14, 9), S(14, 9), S( 9, 5),
    S( 9, 5), S( 9, 5), S( 9, 5), S( 0, 0), S( 9, 5), S(14, 9), S(14, 9), S( 9, 5),
    S( 9, 5), S( 0, 0), S(14, 9), S( 9, 5), S( 0, 0), S( 9, 5), S( 9, 5), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 9, 5), S( 0, 0), S( 0, 0), S( 9, 5), S( 9, 5), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 9, 5), S( 9, 5), S( 0, 0), S( 9, 5), S( 0, 0), S( 0, 0),
    S( 9, 5), S( 9, 5), S( 9, 5), S( 0, 0), S( 9, 5), S(14, 9), S(14, 9), S( 9, 5),
    S( 9, 5), S( 0, 0), S(14, 9), S( 9, 5), S( 9, 5), S( 9, 5), S( 9, 5), S( 3, 0),
    S( 0, 0), S( 0, 0), S( 9, 5), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0),
    S( 9, 5), S( 0, 0), S(14, 9), S( 9, 5), S( 0, 0), S( 9, 5), S( 9, 5), S( 3, 0),
    S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 9, 5), S( 9, 5), S( 3, 0),
    S( 0, 0), S( 0, 0), S( 9, 5), S( 3, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0) };

...
namespace {
  ...
  constexpr Score Semiopen[256] = {
    S(-1, 3), S(-1, 3), S( 8, 5), S(-1, 3), S(-1, 3), S( 8, 5), S( 8, 5), S(-1, 3),
    S(-1, 3), S(-1, 3), S( 8, 5), S( 8, 5), S(-1, 3), S( 8, 5), S( 8, 5), S(-1, 3),
    S(-1, 3), S(-1, 3), S( 8, 5), S(-1, 3), S( 8, 5), S( 8, 5), S( 8, 5), S( 8, 5),
    S(-1, 3), S(-1, 3), S( 8, 5), S( 8, 5), S(-1, 3), S( 8, 5), S( 8, 5), S(-1, 3),
    S(-1, 3), S(-1, 3), S( 8, 5), S(-1, 3), S(-1, 3), S( 8, 5), S( 8, 5), S(-1, 3),
    S( 8, 5), S( 8, 5), S(10, 5), S( 8, 5), S( 8, 5), S( 8, 5), S( 8, 5), S(-1, 3),
    S(-1, 3), S(-1, 3), S( 8, 5), S(-1, 3), S( 8, 5), S( 8, 5), S( 8, 5), S(-1, 3),
    S(-1, 3), S(-1, 3), S( 8, 5), S(-1, 3), S(-1, 3), S( 8, 5), S(-1, 3), S(-1, 3),
    S( 8, 5), S( 8, 5), S( 8, 5), S( 8, 5), S( 8, 5), S( 8, 5), S( 8, 5), S( 8, 5),
    S( 8, 5), S( 8, 5), S(10, 5), S( 8, 5), S( 8, 5), S( 8, 5), S( 8, 5), S(-1, 3),
    S( 8, 5), S( 8, 5), S(10, 5), S( 8, 5), S(10, 5), S(18,10), S(18,10), S(10, 5),
    S( 8, 5), S( 8, 5), S(18,10), S(10, 5), S( 8, 5), S(10, 5), S(10, 5), S( 8, 5),
    S( 8, 5), S(-1, 3), S( 8, 5), S(-1, 3), S( 8, 5), S( 8, 5), S( 8, 5), S(-1, 3),
    S( 8, 5), S( 8, 5), S(18,10), S(10, 5), S( 8, 5), S(10, 5), S(10, 5), S( 8, 5),
    S( 8, 5), S( 8, 5), S( 8, 5), S(-1, 3), S( 8, 5), S(10, 5), S(10, 5), S( 8, 5),
    S( 8, 5), S(-1, 3), S(10, 5), S( 8, 5), S(-1, 3), S( 8, 5), S( 8, 5), S(-1, 3),
    S(-1, 3), S(-1, 3), S( 8, 5), S(-1, 3), S(-1, 3), S( 8, 5), S( 8, 5), S(-1, 3),
    S(-1, 3), S(-1, 3), S( 8, 5), S( 8, 5), S(-1, 3), S( 8, 5), S( 8, 5), S(-1, 3),
    S(-1, 3), S(-1, 3), S( 8, 5), S(-1, 3), S( 8, 5), S( 8, 5), S( 8, 5), S(-1, 3),
    S(-1, 3), S(-1, 3), S( 8, 5), S(-1, 3), S(-1, 3), S(-1, 3), S(-1, 3), S(-1, 3),
    S( 8, 5), S( 8, 5), S( 8, 5), S( 8, 5), S( 8, 5), S( 8, 5), S( 8, 5), S(-1, 3),
    S( 8, 5), S( 8, 5), S(18,10), S(10, 5), S( 8, 5), S(10, 5), S(10, 5), S( 8, 5),
    S( 8, 5), S( 8, 5), S( 8, 5), S(-1, 3), S( 8, 5), S(10, 5), S(10, 5), S( 8, 5),
    S( 8, 5), S(-1, 3), S(10, 5), S( 8, 5), S(-1, 3), S( 8, 5), S( 8, 5), S(-1, 3),
    S(-1, 3), S(-1, 3), S( 8, 5), S(-1, 3), S(-1, 3), S( 8, 5), S( 8, 5), S(-1, 3),
    S(-1, 3), S(-1, 3), S( 8, 5), S( 8, 5), S(-1, 3), S( 8, 5), S(-1, 3), S(-1, 3),
    S( 8, 5), S( 8, 5), S( 8, 5), S(-1, 3), S( 8, 5), S(10, 5), S(10, 5), S( 8, 5),
    S( 8, 5), S(-1, 3), S(10, 5), S( 8, 5), S( 8, 5), S( 8, 5), S( 8, 5), S( 4,-1),
    S(-1, 3), S(-1, 3), S( 8, 5), S(-1, 3), S(-1, 3), S(-1, 3), S(-1, 3), S(-1, 3),
    S( 8, 5), S(-1, 3), S(10, 5), S( 8, 5), S(-1, 3), S( 8, 5), S( 8, 5), S( 4,-1),
    S(-1, 3), S(-1, 3), S(-1, 3), S(-1, 3), S(-1, 3), S( 8, 5), S( 8, 5), S( 4,-1),
    S(-1, 3), S(-1, 3), S( 8, 5), S( 4,-1), S(-1, 3), S(-1, 3), S(-1, 3), S(-1, 3) };

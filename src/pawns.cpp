...
namespace {
  ...
  constexpr Score Semiopen[256] = {
    ...
    S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 9,15), S( 5,10), S( 0, 0), S( 5,10), S( 5,10), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 5,10), S( 5,10), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 5,10), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 9,15), S( 5,10), S( 0, 0), S( 5,10), S( 5,10), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 9,15), S( 5,10), S( 9,15), S(12,20), S(12,20), S( 9,15),
    S( 0, 0), S( 5,10), S(12,20), S( 9,15), S( 5,10), S( 9,15), S( 9,15), S( 5,10),
    S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 5,10), S( 5,10), S( 0, 0),
    S( 0, 0), S( 5,10), S(12,20), S( 9,15), S( 5,10), S( 9,15), S( 9,15), S( 5,10),
    S( 0, 0), S( 0, 0), S( 5,10), S( 0, 0), S( 5,10), S( 9,15), S( 9,15), S( 5,10),
    S( 0, 0), S( 0, 0), S( 9,15), S( 5,10), S( 0, 0), S( 5,10), S( 5,10), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 5,10), S( 5,10), S( 0, 0),

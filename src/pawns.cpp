...
namespace {
  ...
  constexpr Score Semiopen[256] = {
    S( 0, 0), S( 0, 0), S(10, 5), S( 0, 0), S( 0, 0), S(10, 5), S(10, 5), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 8, 4), S( 8, 4), S( 0, 0), S( 8, 4), S( 8, 4), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 8, 4), S( 0, 0), S( 8, 4), S( 8, 4), S( 8, 4), S( 8, 4),
    S( 0, 0), S( 0, 0), S( 8, 4), S( 8, 4), S( 0, 0), S( 8, 4), S( 8, 4), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 8, 4), S( 0, 0), S( 0, 0), S( 8, 4), S( 8, 4), S( 0, 0),
    S( 8, 4), S( 8, 4), S(12, 7), S( 8, 4), S( 8, 4), S( 8, 4), S( 8, 4), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 8, 4), S( 0, 0), S( 8, 4), S( 8, 4), S( 8, 4), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 8, 4), S( 0, 0), S( 0, 0), S( 8, 4), S( 0, 0), S( 0, 0),
    S( 8, 4), S( 8, 4), S( 8, 4), S( 8, 4), S( 8, 4), S( 8, 4), S( 8, 4), S( 8, 4),
    S( 8, 4), S( 8, 4), S(12, 7), S( 8, 4), S( 8, 4), S( 8, 4), S( 8, 4), S( 0, 0),
    S( 8, 4), S( 8, 4), S(12, 7), S( 8, 4), S(12, 7), S(16,10), S(16,10), S(12, 7),
    S( 8, 4), S( 8, 4), S(16,10), S(12, 7), S( 8, 4), S(12, 7), S(12, 7), S( 8, 4),
    S( 8, 4), S( 0, 0), S( 8, 4), S( 0, 0), S( 8, 4), S( 8, 4), S( 8, 4), S( 0, 0),
    S( 8, 4), S( 8, 4), S(16,10), S(12, 7), S( 8, 4), S(12, 7), S(12, 7), S( 8, 4),
    S( 8, 4), S( 8, 4), S( 8, 4), S( 0, 0), S( 8, 4), S(12, 7), S(12, 7), S( 8, 4),
    S( 8, 4), S( 0, 0), S(12, 7), S( 8, 4), S( 0, 0), S( 8, 4), S( 8, 4), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 8, 4), S( 0, 0), S( 0, 0), S( 8, 4), S( 8, 4), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 8, 4), S( 8, 4), S( 0, 0), S( 8, 4), S( 8, 4), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 8, 4), S( 0, 0), S( 8, 4), S( 8, 4), S( 8, 4), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 8, 4), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0),
    S( 8, 4), S( 8, 4), S( 8, 4), S( 8, 4), S( 8, 4), S( 8, 4), S( 8, 4), S( 0, 0),
    S( 8, 4), S( 8, 4), S(16,10), S(12, 7), S( 8, 4), S(12, 7), S(12, 7), S( 8, 4),
    S( 8, 4), S( 8, 4), S( 8, 4), S( 0, 0), S( 8, 4), S(12, 7), S(12, 7), S( 8, 4),
    S( 8, 4), S( 0, 0), S(12, 7), S( 8, 4), S( 0, 0), S( 8, 4), S( 8, 4), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 8, 4), S( 0, 0), S( 0, 0), S( 8, 4), S( 8, 4), S( 0, 0),
    S( 0, 0), S( 0, 0), S( 8, 4), S( 8, 4), S( 0, 0), S( 8, 4), S( 0, 0), S( 0, 0),
    S( 8, 4), S( 8, 4), S( 8, 4), S( 0, 0), S( 8, 4), S(12, 7), S(12, 7), S( 8, 4),
    S( 8, 4), S( 0, 0), S(12, 7), S( 8, 4), S( 8, 4), S( 8, 4), S( 8, 4), S( 3, 0),
    S( 0, 0), S( 0, 0), S( 8, 4), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0),
    S( 8, 4), S( 0, 0), S(12, 7), S( 8, 4), S( 0, 0), S( 8, 4), S( 8, 4), S( 3, 0),
    S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 8, 4), S( 8, 4), S( 3, 0),
    S( 0, 0), S( 0, 0), S( 8, 4), S( 3, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0) };

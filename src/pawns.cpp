...
Entry* probe(const Position& pos) {
  ...
  e->unopposedPawns[WHITE] = popcount((~e->semiopenFiles[WHITE] & e->semiopenFiles[BLACK]) | e->passedPawns[WHITE])
                            - popcount(e->passedPawns[BLACK]);
  e->unopposedPawns[BLACK] = popcount((~e->semiopenFiles[BLACK] & e->semiopenFiles[WHITE]) | e->passedPawns[BLACK])

...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Queen
   { S( 3,-59), S(-5,-47), S(-5,-37), S( 4,-16) },
   { S(-3,-45), S( 5,-21), S( 8,-12), S(12,  6) },
   { S(-3,-29), S( 6,- 8), S(13,  1), S( 7, 13) },
   { S( 4,-13), S( 5,  7), S( 9, 23), S( 8, 34) },
   { S( 0,-19), S(14,  4), S(12, 19), S( 5, 31) },
   { S(-4,-28), S(10,- 8), S( 6,- 2), S( 8, 11) },
   { S(-5,-40), S( 6,-17), S(10,-14), S( 8,  2) },
   { S(-2,-65), S(-2,-42), S( 1,-33), S(-2,-26) }
  },
  { // King

...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Queen
   { S( 3,-39), S(-5,-27), S(-5,-17), S( 4,  4) },
   { S(-3,-25), S( 5,- 1), S( 8,  8), S(12, 26) },
   { S(-3,- 9), S( 6, 12), S(13, 21), S( 7, 33) },
   { S( 4,  7), S( 5, 27), S( 9, 43), S( 8, 54) },
   { S( 0,  1), S(14, 24), S(12, 39), S( 5, 51) },
   { S(-4,- 8), S(10, 12), S( 6, 18), S( 8, 31) },
   { S(-5,-20), S( 6,  3), S(10,  6), S( 8, 22) },
   { S(-2,-45), S(-2,-22), S( 1,-13), S(-2,- 6) }
  },
  { // King

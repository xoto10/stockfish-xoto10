...
// adjustments to pawn psqt
Score pa[COLOR_NB][64] = { { S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0),
                             S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0),
                             S( 0, 0), S( 0, 0), S( 0, 0), S( 0,-3), S( 4,-3), S( 0, 0), S( 0, 0), S( 0, 0),
                             S( 0, 0), S( 0, 0), S( 0, 0), S(-5, 2), S(-3,-6), S( 0, 0), S( 0, 0), S( 0, 0),
                             S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 4), S( 3, 0), S( 0, 0), S( 0, 0), S( 0, 0),
                             S( 0, 0), S( 0, 0), S( 0, 0), S(-3,-1), S( 3, 3), S( 0, 0), S( 0, 0), S( 0, 0),
                             S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0),
                             S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0) }
                         , { S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0),
                             S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0),
                             S( 0, 0), S( 0, 0), S( 0, 0), S(-5, 0), S(-3,-5), S( 0, 0), S( 0, 0), S( 0, 0),
                             S( 0, 0), S( 0, 0), S( 0, 0), S(-4, 4), S(-2,-1), S( 0, 0), S( 0, 0), S( 0, 0),
                             S( 0, 0), S( 0, 0), S( 0, 0), S( 5,-3), S( 1, 3), S( 0, 0), S( 0, 0), S( 0, 0),
                             S( 0, 0), S( 0, 0), S( 0, 0), S( 1, 1), S( 1, 0), S( 0, 0), S( 0, 0), S( 0, 0),
                             S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0),
                             S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0) }
                         };
...
void init() {
  ...
  // adjustments found by tuning
  for (Square s = SQ_A1; s <= SQ_H8; ++s)
  {
      psq[WHITE][s] += pa[WHITE][s];
      psq[BLACK][s] += pa[BLACK][s];
  }

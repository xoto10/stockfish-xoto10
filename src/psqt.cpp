...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-44,-40), S( -4,- 7), S(-11,-12), S(-28, 15) },
   { S(-18,-15), S(  7, 10), S( 14,  9), S(  3, 23) },
   { S( -8,  5), S( 24, 23), S( -3, 16), S( 15, 36) },
   { S(  1,- 3), S(  8, 20), S( 26, 24), S( 37, 39) },
   { S( -7,- 1), S( 30, 17), S( 23, 13), S( 28, 40) },
   { S(-17,- 3), S(  4, 25), S( -1, 24), S(  8, 39) },
   { S(-21,-11), S(-19,  5), S( 10, 16), S( -6, 32) },
   { S(-48,-28), S( -3,-17), S(-12,-16), S(-25,  3) }
  },
  { // Rook

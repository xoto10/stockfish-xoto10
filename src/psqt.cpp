...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   ...
   { S(-11, -6), S(-10,-6), S( 15,-1), S( 22,-1), S( 18, -1), S( 28,  2), S(  4,-2), S(-24, -5) },
   { S( -9,  4), S(-18,-5), S(  8,-4), S( 22,-5), S( 25,  2), S( 25,-13), S( -4,-3), S(-16, -7) },
   { S(  6, 18), S( -3, 2), S(-10, 2), S(  1,-9), S( 20, 14), S(  6, -8), S(-12,11), S(  1,  9) },
   { S( -6, 25), S( -8,17), S(  5,19), S( 11,29), S(  2, 13), S(  0,  8), S(-12, 4), S(-14, 12) },

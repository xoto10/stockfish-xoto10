...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Rook
   { S(-25, -2), S(-14,-6), S(-8, -3), S( 1,-2) },
   { S(-19,-10), S(-11,-7), S(-6,  1), S( 8, 0) },
   { S(-14, 10), S(  0,-4), S(10,  2), S( 6,-2) },
   { S(-14, -5), S( -6, 2), S(-5, -8), S(-7, 8) },
   { S(-25, -8), S(-13, 5), S(-2,  4), S( 5,-9) },
   { S(-25,  3), S( -5,-2), S( 3,-10), S( 9, 7) },
   { S( -9,  1), S(  5, 2), S( 9, 17), S(11,-8) },
   { S(-23, 12), S(-25,-6), S(-7, 13), S( 3, 7) }
  },
  { // Queen

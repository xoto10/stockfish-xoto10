...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-44,-54), S( -4,-21), S(-11,-26), S(-28,  1) },
   { S(-18,-29), S(  7,- 4), S( 14,- 5), S(  3,  9) },
   { S( -8,- 9), S( 24,  9), S( -3,  2), S( 15, 22) },
   { S(  1,-17), S(  8,  6), S( 26, 10), S( 37, 25) },
   { S( -7,-15), S( 30,  3), S( 23,- 1), S( 28, 26) },
   { S(-17,-17), S(  4, 11), S( -1, 10), S(  8, 25) },
   { S(-21,-25), S(-19,- 9), S( 10,  2), S( -6, 18) },
   { S(-48,-42), S( -3,-31), S(-12,-30), S(-25,-11) }
  },
  { // Rook

...
void Thread::search() {
         ...
         && !(Limits.depth && mainThread && rootDepth / ONE_PLY > Limits.depth))
  {
      ...
      if (mainThread)
          Threads.bestMoveChanges = Threads.bestMoveChanges / 2;
          ...
          && !mainThread->stopOnPonderhit)
      {
          ...
          double bestMoveInstability = 1.0 + double(Threads.bestMoveChanges) / Threads.size() / 256;

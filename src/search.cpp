...
namespace {
  ...
  constexpr int IF1[2] = { 267, 270}, IF2[2] = { 899, 863}, IF3[2] = { 311, 298},
                IF4[2] = { 114, 118}, IF5[2] = {   6,   5}, IF7[2] = { 573, 540};
  constexpr int IF6    = 33;
  constexpr int TR1[2] = {1034,1038}, TR2[2] = {1120,1101}, TR3[2] = {1206,1251}, TR4[2] = {1564,1535}, TR5[2] = {2076,2127};
  constexpr int MI1[2] = { 525, 513}, MI2[2] = {  58,  62};

...
//sync_cout << "info string xo " << (147+delta)/8 << " ala " << 21+abs(previousScore)/128
//          << " new " << 21 + (abs(previousScore) + 8 * delta) / 256 << sync_endl;
              delta = Value(21 + (abs(previousScore) + 8 * delta) / 256);

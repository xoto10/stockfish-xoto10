...
void Thread::search() {
  ...
  contempt = (us == WHITE ?  make_score(ct, ct / 2)
                          : -make_score(ct, ct / 2));
  castlingStopped[us] = false, castled[us] = false;
...
//    else
      if (type_of(move) == CASTLING)
          thisThread->castled[us] = undoCastlingStopped = true;
      ...
      if (undoCastlingStopped)
          thisThread->castlingStopped[us] = thisThread->castled[us] = undoCastlingStopped = false;

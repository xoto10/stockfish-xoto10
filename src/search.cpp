...
namespace {
  ...
  int IF1[2] = { 260, 254}, IF2[2] = { 850, 847}, IF3[2] = { 339, 308},
      IF4[2] = { 116, 108}, IF5[2] = {   6,   5}, IF7[2] = { 571, 592};
  int IF6    = 33;
  int TR1[2] = {1077, 996}, TR2[2] = {1074,1125}, TR3[2] = {1161,1271}, TR4[2] = {1574,1461}, TR5[2] = {2032,1993};
  int MI1[2] = { 533, 513}, MI2[2] = {  61,  59};

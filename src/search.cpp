...
namespace {
  ...
  {
    {-18,  15, -11},  // Hidden Layer 1 biases
    {-57,  69, 110}   // Hidden Layer 2 biases
  };
  constexpr int nwo[TMN] = {14, 10,  6}; // Output Layer weights
  constexpr int nbo = -10;               // Output Layer bias

//auto f30 = [](int m){return Range(m - 30, m + 30);};
//auto f50 = [](int m){return Range(m - 50, m + 50);};

//TUNE(SetRange(f50), nw);
//TUNE(SetRange(f50), nb);
//TUNE(SetRange(f30), nwo);
//TUNE(SetRange(f50), nbo);

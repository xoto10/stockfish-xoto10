...
void MainThread::search() {
      ...
      &&  rootMoves[0].pv[0] != MOVE_NONE)
  {
      ...
      std::map<Move, Value> minScoreMove;
      Value minScore = this->rootMoves[0].score;

      for (Thread* th: Threads)
          minScoreMove[th->rootMoves[0].pv[0]] = VALUE_INFINITE;

      // Find out minimum score and reset votes for moves which can be voted
      for (Thread* th: Threads)
      {
          minScore = std::min(minScore, th->rootMoves[0].score);
          minScoreMove[th->rootMoves[0].pv[0]] = std::min( minScoreMove[th->rootMoves[0].pv[0]],
      ...
      for (Thread* th : Threads)
      {
          int64_t s = minScoreMove[th->rootMoves[0].pv[0]] - minScore + 1;

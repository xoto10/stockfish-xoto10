...
void Thread::search() {
         ...
         && !(Limits.depth && mainThread && rootDepth > Limits.depth))
  {
          ...
          && !mainThread->stopOnPonderhit)
      {
          ...
          if (reduction * bestMoveInstability < 0.8)
              fallingEval *= 0.8 / (reduction * bestMoveInstability);
          fallingEval = std::clamp(fallingEval, 0.5, 1.5);

          double totalTime = Time.optimum() * reduction * bestMoveInstability * fallingEval;

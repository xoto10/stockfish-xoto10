...
static constexpr double C[11] = { 0.057, 0.119, 0.118, 0.114, 0.054, 0.084, 0.067, 0.018, 1.284, 5.832, 0.512 };
//possibles for half range: 0,3,4*,6,7
//int C[] = { 55, 104, 99, 103, 58, 67, 58, 17, 1096, 5204, 700 };
//TUNE(C);

...
int A=225, B=200, C=244, D=295, E=231;
...
void TimeManagement::init(Search::LimitsType& limits,
    ...
    if (limits.movestogo == 0)
    {
        ...
        double optConstant =
          std::min(A/100000.0 + 0.000811 * std::log10((B*originalTime + (200-B)*limits.time[us]) / 400000.0), 0.00506);
        double maxConstant = std::max(3.39 + 3.01 * std::log10(limits.time[us] / 1000.0), 2.93);

        optScale = std::min(C/20000.0 + std::pow(ply + D/100.0, E/500.0) * optConstant,

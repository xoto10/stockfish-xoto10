...
void TimeManagement::time_pressure(Search::LimitsType& limits) {

  double t1 = limits.time[WHITE] + 10 * limits.inc[WHITE];
  double t2 = limits.time[BLACK] + 10 * limits.inc[BLACK];

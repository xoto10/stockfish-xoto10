...
public:
  ...
  //Eval: <-20 -10  <0 >=0 >10 >20 >30
          {  0,  0,  0,  0,  1,  0,  0,  0},  //        Diff < -30
          {  0,  0,  0,  5,  1,  0,  0,  0},  // -30 <= Diff < -20
          {  0,  0,  0,  0,  0,  2,  1,  1},  // -20 <= Diff < -10
          {  1,  3,  0,  1,  0,  0,  0,  1},  // -10 <= Diff <   0
          {  0,  2,  2,  0,  0,  0,  0,  2},  //   0 <= Diff <  10
          {  2,  0,  0,  0,  0,  0,  2,  5},  //  10 <= Diff <  20
          {  1,  0,  0,  0,  0,  0,  6,  7},  //  20 <= Diff <  30
          {  1,  0,  0,  0,  1,  5, 14, 11}   //  30 <= Diff
      },
      {            //  Black
  //Eval: <-40 -30 -20 -10  <0 >=0 >10 >20
          {  0,  0,  0,  0,  0,  1,  0,  1},  //        Diff < -30
          {  0,  0,  0,  0,  0,  1,  0,  3},  // -30 <= Diff < -20
          {  0,  0,  0,  0,  0,  0,  0,  0},  // -20 <= Diff < -10
          {  3,  0,  0,  0,  0,  0,  0,  2},  // -10 <= Diff <   0
          {  0,  0,  1,  1,  0,  0,  1,  0},  //   0 <= Diff <  10
          {  0,  0,  0,  0,  0,  1,  3,  5},  //  10 <= Diff <  20
          {  0,  0,  0,  0,  0,  6,  8,  3},  //  20 <= Diff <  30
          {  0,  0,  0,  0,  0, 16, 18, 11}   //  30 <= Diff
      }
